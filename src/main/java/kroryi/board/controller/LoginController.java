...
public class LoginController {
    ...
    public void gotRegister(ActionEvent event) throws IOException {
    ...
    public class StringResource{
        ...
        static {
            ...
            errorMessages.put(ErrorCode.LOGIN_FAILED, "비민번호가 일치 하지 않습니다. \n 다시 확인 바랍니다.");
            errorMessages.put(ErrorCode.LOGIN_SUCCESS, "%s 닌 환경합니다.\n 프로그램에 접속합니다.");

        }
        public static  String getErrorMessage(ErrorCode errorCode){
            return errorMessages.get(errorCode); // HaspMap
        }
    }
